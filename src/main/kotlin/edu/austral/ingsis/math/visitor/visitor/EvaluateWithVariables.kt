...
class EvaluateWithVariables(val variableValues: Map<String, Number>): Visitor<Number> {
    ...
    override fun visit(variable: Variable): Result<Number> {
        val value: Number = variableValues[variable.name] ?:
        return Result.failure(Exception("Can not evaluate variable"))
