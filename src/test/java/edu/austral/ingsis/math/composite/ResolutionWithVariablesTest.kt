...
class ResolutionWithVariablesTest {
    ...
    fun shouldResolveFunction1() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(4.0)))
    }
    ...
    fun shouldResolveFunction2() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(3.0)))
    }
    ...
    fun shouldResolveFunction3() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(12.0)))
    }
    ...
    fun shouldResolveFunction4() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(27.0)))
    }
    ...
    fun shouldResolveFunction5() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(6.0)))
    }
    ...
    fun shouldResolveFunction6() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(0.0)))
    }
    ...
    fun shouldResolveFunction8() {
        ...
        assertThat(function.evaluate(variableValues = variables).getOrNull(), equalTo(Number(24.0)))
    }
}
